...
type Service struct {
	manager    *firewall.UnblockManager
	interfaces InterfaceLookup
	xrays      XrayLookup
}

func New(manager *firewall.UnblockManager, interfaces InterfaceLookup, xrays XrayLookup) *Service {
	return &Service{
		manager:    manager,
...
func (s *Service) RuntimeOptions() firewall.RuleRuntimeOptions {
	return firewall.RuleRuntimeOptions{
